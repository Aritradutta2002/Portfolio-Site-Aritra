...
export const APPS: AppDefinition[] = [
  ...
  },
  {
    ...
    label: 'Music',
    icon: 'music',
    description: 'Play your favorite tracks from the desktop',
    keywords: ['songs', 'audio', 'player', 'playlist', 'artists'],
    dock: true,
    desktop: true,
  },
  {
    ...
    label: 'Mail',
    icon: 'mail',
    description: 'Write a message and get in touch',
    keywords: ['email', 'inbox', 'message', 'contact', 'gmail'],
    dock: true,
    desktop: true,
  },
  {
    ...
    label: 'Aurora',
    icon: 'browser',
    description: 'Explore the web and this portfolio',
    keywords: ['web', 'internet', 'browser', 'safari', 'links'],
    dock: true,
    desktop: true,
  },
  {
